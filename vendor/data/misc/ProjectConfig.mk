...
CUSTOM_HAL_IMGSENSOR = gc5035mipi_raw gc2385mipi_raw gc5025mipi_raw gc030amipi_raw ov5645_mipi_raw sp2508_mipi_raw sp2509_mipi_raw hi551mipiraw
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_IMGSENSOR = gc5035mipi_raw gc5025mipi_raw ov5645_mipi_raw hi551mipiraw
CUSTOM_HAL_MSENSORLIB =akl
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = gc2385mipi_raw gc030amipi_raw sp2508_mipi_raw sp2509_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = gc5035mipi_raw gc2385mipi_raw gc5025mipi_raw gc030amipi_raw ov5645_mipi_raw sp2508_mipi_raw sp2509_mipi_raw hi551mipiraw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
#CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc5035mipi_raw gc5025mipi_raw ov5645_mipi_raw hi551mipiraw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc2385mipi_raw gc030amipi_raw sp2508_mipi_raw sp2509_mipi_raw
...
CUSTOM_MODEM = PRJ8009AL_V265.3_QUAD_B1B8_NO_RX_TXEDGE_V006
#PRJ8021Y_M45009WG_V265.3_QUAD_B1B5B8_NO_TXEDGE_V005
...
MTK_GPU_VERSION = mali utgard r10p0-01dev0
...
#for languge
#PRODUCT_LOCALES := ru_RU en_GB en_US es_US fr_FR bn_BD zh_CN zh_TW es_ES pt_BR de_DE tr_TR vi_VN ms_MY in_ID th_TH it_IT ar_EG hi_IN bn_IN ur_PK fa_IR pt_PT nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ ko_KR km_KH iw_IL my_MM pl_PL bg_BG hr_HR lv_LV lt_LT sk_SK uk_UA de_AT da_DK fi_FI nb_NO sv_SE hy_AM zh_HK et_EE ja_JP kk_KZ sr_RS sl_SI ca_ES

### GMS PACKAGE ###
BUILD_GMS = yes
GMS_RUSSIA_SUPPORT=yes
GMS_COUNTRY_YOUTUBE_SUPPORT=yes

FISE_PRODUCT_MODEL=A2
FISE_PRODUCT_BRAND=Haier
FISE_PRODUCT_BOARD=A2
FISE_PRODUCT_NAME=A2
FISE_PRODUCT_DEVICE=A2
FISE_BUILD_PRODUCT=A2
FISE_PRODUCT_MANUFACTURER=Haier
FISE_CUSTOM_DEFINE_CLIENTID=android-haier
#FISE_BUILD_NUMBER=

PROJECT_FISE_APP_USE=8009CF


TRUSTKERNEL_TEE_PLATFORM_APP_SUPPORT = yes

TRUSTKERNEL_TEE_VER_PATCH=file_6m
FISE_RU_CUSTOM_SUPPORT=yes
FISE_CAM_ADD_SPECIAL_SIZE=yes
FISE_MAIN_CAM_ADD_5M_CAPTURE_SIZE=yes
FISE_SUB_CAM_ADD_2M_CAPTURE_SIZE=yes

CUSTOM_KERNEL_PS=yes
FISE_FLASHLIGHT_SUB_STROBE=yes

FSSZ_GOTA_SUPPORT=yes
GOTA_SUPPORT=yes


### --- Auto gen, not modify! ---###

FS_NOT_GMS_CERTIFIED_DEMO_VERSION=no

MTK_BUILD_VERNO = alps-mp-q0.mp1-V8.4_P14

MTK_WEEK_NO = W20.21

FS_BUILD_SW_VERSION=A2_H01_S001_20200703_RU

FS_SW_FIXED_VERSION=A2_H01_S001_20200703_RU
